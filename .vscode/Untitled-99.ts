...
<head>
  <meta charset="UTF-8">
  <title>Tamil Nadu District Education Stats</title>
...
<body class="bg-light">
  <div class="container mt-4">
    ...
    <div class="mb-4 text-center">
      <iframe title="Tamil Nadu District Map" aria-label="Map" id="datawrapper-chart" src="https://datawrapper.dwcdn.net/Il2VG/1/" scrolling="no" frameborder="0" style="width: 100%; min-width: 300px; border: none;" height="500"></iframe>
    </div>
  ...
  <script>
    ...
    // Render district buttons dynamically
